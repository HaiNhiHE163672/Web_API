...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WA_1_1_QuanLySanPham.Models.ChiTietHoaDon", b =>
                {
            ...
            modelBuilder.Entity("WA_1_1_QuanLySanPham.Models.HoaDon", b =>
                {
                    b.Property<int>("HoaDonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WA_1_1_QuanLySanPham.Models.KhachHang", b =>
                {
                    b.Property<int>("KhachHangId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WA_1_1_QuanLySanPham.Models.LoaiSanPham", b =>
                {
            ...
            modelBuilder.Entity("WA_1_1_QuanLySanPham.Models.SanPham", b =>
                {
                    b.Property<int>("SanPhamId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WA_1_1_QuanLySanPham.Models.ChiTietHoaDon", b =>
                {
                    b.HasOne("WA_1_1_QuanLySanPham.Models.HoaDon", "HoaDon")
                        .WithMany("ChiTietHoaDons")
                        .HasForeignKey("HoaDonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WA_1_1_QuanLySanPham.Models.SanPham", "SanPham")
                        .WithMany()
            ...
            modelBuilder.Entity("WA_1_1_QuanLySanPham.Models.HoaDon", b =>
                {
                    b.HasOne("WA_1_1_QuanLySanPham.Models.KhachHang", "KhachHang")
                        .WithMany()
            ...
            modelBuilder.Entity("WA_1_1_QuanLySanPham.Models.SanPham", b =>
                {
                    b.HasOne("WA_1_1_QuanLySanPham.Models.LoaiSanPham", "LoaiSanPham")
                        .WithMany()
